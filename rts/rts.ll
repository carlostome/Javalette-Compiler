...
define i8* @search_method(%ClassMethod* %entry, i64 %tag) {
  ...
  %4 = load %ClassMethod*, %ClassMethod** %2, align 8
...
; <label>:7                                       ; preds = %0
  %8 = load %ClassMethod*, %ClassMethod** %2, align 8
  %9 = getelementptr inbounds %ClassMethod, %ClassMethod* %8, i32 0, i32 0
...
; <label>:13                                      ; preds = %7
  %14 = load %ClassMethod*, %ClassMethod** %2, align 8
  %15 = getelementptr inbounds %ClassMethod, %ClassMethod* %14, i32 0, i32 2
  %16 = load i8*, i8** %15, align 8
  store i8* %16, i8** %1
  br label %23

; <label>:17                                      ; preds = %7
  %18 = load %ClassMethod*, %ClassMethod** %2, align 8
  %19 = getelementptr inbounds %ClassMethod, %ClassMethod* %18, i32 0, i32 1
  %20 = load %ClassMethod*, %ClassMethod** %19, align 8
...
define i8* @dispatcher(i64 %tag, %ClassDescriptor* %descr) {
  ...
  %4 = load %ClassDescriptor*, %ClassDescriptor** %3, align 8
  %5 = getelementptr inbounds %ClassDescriptor, %ClassDescriptor* %4, i32 0, i32 1
  %6 = load %ClassMethod*, %ClassMethod** %5, align 8
  %7 = load i64, i64* %2, align 8
  %8 = call i8* @search_method(%ClassMethod* %6, i64 %7)
  store i8* %8, i8** %entry, align 8
  %9 = load %ClassDescriptor*, %ClassDescriptor** %3, align 8
  %10 = icmp eq %ClassDescriptor* %9, null
  br i1 %10, label %11, label %15

; <label>:11                                      ; preds = %0
  %12 = load i8*, i8** %entry, align 8
...
; <label>:15                                      ; preds = %11, %0
  %16 = load i8*, i8** %entry, align 8
  %17 = icmp eq i8* %16, null
  br i1 %17, label %18, label %24

; <label>:18                                      ; preds = %15
  %19 = load i64, i64* %2, align 8
  %20 = load %ClassDescriptor*, %ClassDescriptor** %3, align 8
  %21 = getelementptr inbounds %ClassDescriptor, %ClassDescriptor* %20, i32 0, i32 0
  %22 = load %ClassDescriptor*, %ClassDescriptor** %21, align 8
  %23 = call i8* @dispatcher(i64 %19, %ClassDescriptor* %22)
  store i8* %23, i8** %1
  br label %26

; <label>:24                                      ; preds = %15
  %25 = load i8*, i8** %entry, align 8
  store i8* %25, i8** %1
  br label %26
